    ...
    return (
        <div
            className={cn(
                'rounded-2xl',
                toneClasses[tone],
                glow && 'relative before:absolute before:inset-0 before:-z-10 before:rounded-[40px] before:bg-[radial-gradient(circle_at_top,hsl(32_96%_52%_/0.18),transparent_60%)] before:blur-2xl',
                grid && 'grid-display',
                className,
            )}
        >
