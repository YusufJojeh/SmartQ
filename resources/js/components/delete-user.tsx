...
export default function DeleteUser() {
    ...
    return (
        <div className="space-y-6">
            <HeadingSmall title={t('settings.deleteAccount')} description={t('settings.deleteAccountDescription')} />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                    <p className="font-medium">{t('settings.warning')}</p>
                    <p className="text-sm">{t('settings.deleteWarning')}</p>
                </div>
                        ...
                        <form className="space-y-6" onSubmit={deleteUser}>
                            ...
                            <DialogFooter>
                                ...
                                <Button variant="destructive" disabled={processing} asChild>
                                    <button type="submit">{t('settings.deleteAccount')}</button>
                                </Button>
                            </DialogFooter>
                        </form>
                    </DialogContent>
